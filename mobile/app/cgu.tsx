...
const sections: Section[] = [
  ...
  { title: "5. Abonnement Premium (TextMe)", body: "Texto propose un abonnement payant TextMe facturé en Francs CFA (XOF) via Orange Money. Les abonnements sont non remboursables sauf en cas de défaut technique avéré. Vous pouvez annuler à tout moment depuis votre profil." },
