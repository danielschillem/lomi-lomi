...
export default function CartePage() {
  ...
  return (
    <div className="h-screen flex flex-col">
      {/* Header */}
      <header className="shrink-0 bg-surface/80 backdrop-blur-md border-b border-border px-4 py-3 z-20">
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        {/* Sidebar */}
        <div className="md:w-96 shrink-0 border-t md:border-t-0 md:border-l border-border bg-white overflow-y-auto max-h-[35vh] md:max-h-none">
          {selected ? (
            <div className="p-6">
              <button
                onClick={() => setSelected(null)}
                className="text-xs text-muted hover:text-foreground transition mb-4 inline-flex items-center gap-1"
              >
            ...
            <div className="p-4 space-y-2">
              ...
              {places.map((place) => (
                ...
                >
                  ...
                  {place.rating > 0 && (
                    <span className="shrink-0 text-xs text-yellow-600 flex items-center gap-0.5 ml-auto">
